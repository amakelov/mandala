...
![svg](01_cf_files/01_cf_2_0.svg)
    ...
    |  4 |   0 | Call(increment, cid='d47...', hid='230...') |   1 | Call(add, cid='89c...', hid='247...') |   1 |
...
```
    ...
    |---:|:-------------------------------------------|:---------------------------------------------|:-------------------------------------------------------|
    |  0 | Call(get_data, cid='73a...', hid='73a...') |                                              | Call(get_train_test_split, cid='119...', hid='7be...') |
    |  1 | Call(get_data, cid='73a...', hid='73a...') | Call(scale_data, cid='09f...', hid='d6b...') | Call(get_train_test_split, cid='3d5...', hid='e0a...') |
...
```
    ...
    |---:|-----------:|:---------------------------------------------|:--------------------------------------------|:------------------------------------------------------|
    |  0 |      0.915 | Call(scale_data, cid='09f...', hid='d6b...') |                                             | Call(train_random_forest, cid='e26...', hid='c42...') |
    |  1 |      0.885 |                                              |                                             | Call(train_random_forest, cid='519...', hid='997...') |
...
```
    ...
    |  8 | 10                           |                                            |      0.9   |
    |  9 | 20                           |                                            |      0.9   |
    |  1 | ValueCollection([20, 10, 5]) | ValueCollection(['linear', 'rbf', 'poly']) |      0.895 |
